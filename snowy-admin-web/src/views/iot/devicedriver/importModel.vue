...
<script setup name="iotDeviceDriverImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotDeviceDriverApi
			.iotDeviceDriverImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotDeviceDriverApi.iotDeviceDriverDownloadTemplate().then((res) => {

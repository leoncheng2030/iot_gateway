...
<script setup name="iotDeviceDriverRelImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotDeviceDriverRelApi
			.iotDeviceDriverRelImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotDeviceDriverRelApi.iotDeviceDriverRelDownloadTemplate().then((res) => {

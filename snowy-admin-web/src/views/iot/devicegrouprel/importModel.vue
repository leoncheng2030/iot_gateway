...
<script setup name="iotDeviceGroupRelImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotDeviceGroupRelApi
			.iotDeviceGroupRelImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotDeviceGroupRelApi.iotDeviceGroupRelDownloadTemplate().then((res) => {

...
<script setup name="iotGatewayTopoImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotGatewayTopoApi
			.iotGatewayTopoImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotGatewayTopoApi.iotGatewayTopoDownloadTemplate().then((res) => {

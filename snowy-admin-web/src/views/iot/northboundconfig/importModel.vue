...
<script setup name="iotNorthboundConfigImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotNorthboundConfigApi
			.iotNorthboundConfigImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotNorthboundConfigApi.iotNorthboundConfigDownloadTemplate().then((res) => {

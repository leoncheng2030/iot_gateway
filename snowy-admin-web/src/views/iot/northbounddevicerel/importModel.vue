...
<script setup name="iotNorthboundDeviceRelImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotNorthboundDeviceRelApi
			.iotNorthboundDeviceRelImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotNorthboundDeviceRelApi.iotNorthboundDeviceRelDownloadTemplate().then((res) => {

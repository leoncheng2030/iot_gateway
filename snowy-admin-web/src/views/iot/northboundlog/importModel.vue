...
<script setup name="iotNorthboundLogImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotNorthboundLogApi
			.iotNorthboundLogImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotNorthboundLogApi.iotNorthboundLogDownloadTemplate().then((res) => {

...
<script setup name="iotNorthboundStatisticsImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return iotNorthboundStatisticsApi
			.iotNorthboundStatisticsImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		iotNorthboundStatisticsApi.iotNorthboundStatisticsDownloadTemplate().then((res) => {

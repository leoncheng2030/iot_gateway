 ...
 */
package vip.xiaonuo.iot.modular.devicedriver.param;
...
@Getter
@Setter
public class IotDeviceDriverEditParam {
    ...
    /** 驱动类型 */
    @ExcelProperty("驱动类型")
    @Schema(description = "驱动类型", requiredMode = Schema.RequiredMode.REQUIRED)
